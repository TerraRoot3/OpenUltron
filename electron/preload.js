...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  ai: {
    ...
    listRemoteWebApps: () => ipcRenderer.invoke('web-apps-list-remote'),
    installRemoteWebApps: (data) => ipcRenderer.invoke('web-apps-install-remote', data || {}),
    checkRemoteWebAppUpdates: (data) => ipcRenderer.invoke('web-apps-check-updates', data || {}),
    updateRemoteWebApps: (data) => ipcRenderer.invoke('web-apps-update-remote', data || {}),
    publishWebApp: (data) => ipcRenderer.invoke('web-apps-publish', data || {}),
